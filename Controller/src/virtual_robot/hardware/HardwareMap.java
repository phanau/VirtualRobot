...
public class HardwareMap {
    ...
    public final DeviceMapping<DcMotor> dcMotor = new DeviceMapping<DcMotor>(DcMotor.class);
    public final DeviceMapping<ColorSensor> colorSensor = new DeviceMapping<ColorSensor>(ColorSensor.class);
    public final DeviceMapping<GyroSensor> gyroSensor = new DeviceMapping<GyroSensor>(GyroSensor.class);
    public final DeviceMapping<Servo> servo = new DeviceMapping<Servo>(Servo.class);

    private Map<String, List<HardwareDevice>> allDevicesMap = new HashMap<String, List<HardwareDevice>>(15);
    ...
    public class DeviceMapping<DEVICE_TYPE extends HardwareDevice> implements Iterable<DEVICE_TYPE>{
        ...
        public synchronized Iterator<DEVICE_TYPE> iterator(){
            return new ArrayList<DEVICE_TYPE>(map.values()).iterator();
        }
